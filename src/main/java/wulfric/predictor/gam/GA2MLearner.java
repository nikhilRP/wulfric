...
import wulfric.cmdline.options.HoldoutValidatedLearnerWithTaskOptions;
...
import wulfric.core.Sampling;
import wulfric.core.Attribute.Type;
import wulfric.core.io.InstancesReader;
import wulfric.predictor.BaggedEnsemble;
import wulfric.predictor.BaggedEnsembleLearner;
import wulfric.predictor.BoostedEnsemble;
import wulfric.predictor.HoldoutValidatedLearner;
import wulfric.predictor.Regressor;
import wulfric.predictor.evaluation.Metric;
import wulfric.predictor.evaluation.MetricFactory;
import wulfric.predictor.evaluation.SimpleMetric;
import wulfric.predictor.function.Array2D;
import wulfric.predictor.function.CompressionUtils;
import wulfric.predictor.function.Function2D;
import wulfric.predictor.function.SquareCutter;
import wulfric.predictor.io.PredictorReader;
import wulfric.predictor.io.PredictorWriter;
import wulfric.util.OptimUtils;
import wulfric.util.Random;
import wulfric.util.tuple.IntPair;
...
public class GA2MLearner extends HoldoutValidatedLearner {
	 ...
	 * 
	 * <pre>
	 * usage: wulfric.predictor.gam.GA2MLearner
	 * -t	train set path
	 * -i	input model path
