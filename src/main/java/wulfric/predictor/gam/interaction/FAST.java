package wulfric.predictor.gam.interaction;
...
import wulfric.core.processor.Discretizer;
import wulfric.predictor.function.CHistogram;
import wulfric.predictor.function.Histogram2D;
import wulfric.util.Element;
...
public class FAST {
	 ...
	 * 
	 * <pre>
	 * usage: wulfric.predictor.gam.interaction.FAST
	 * -d	dataset path
	 * -R	residual path
	 * -o	output path
