package wulfric.predictor.tree.ensemble.ag;
...
import wulfric.cmdline.options.LearnerOptions;
...
import wulfric.predictor.evaluation.AUC;
import wulfric.predictor.evaluation.RMSE;
...
import wulfric.predictor.tree.RegressionTreeLearner.Mode;
...
public class AdditiveGrovesLearner extends Learner {
	 ...
	 * 
	 * <pre>
	 * usage: wulfric.predictor.tree.ensemble.ag.AdditiveGrovesLearner
	 * -t	train set path
	 * -v	valid set path
	...
	/**
	 * Sets the metric. Currently only support {@link wulfric.predictor.evaluation.RMSE RMSE} and
	 * {@link wulfric.predictor.evaluation.AUC AUC}.
	 * 
