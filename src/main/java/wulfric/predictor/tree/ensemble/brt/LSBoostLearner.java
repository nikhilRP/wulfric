package wulfric.predictor.tree.ensemble.brt;
...
import wulfric.predictor.Predictor;
...
public class LSBoostLearner extends Learner {
	 ...
	 *
	 * <pre>
	 * usage: wulfric.predictor.tree.ensemble.brt.LSBoostLearner
	 * -t	train set path
